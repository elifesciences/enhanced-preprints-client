...
const resources = {
  en: {
    default: {
      ...
      timeline_version_title_last_version: '$t(timeline_version_title)',
      timeline_version_title_only_version: '$t(timeline_version_title)',
      external_timeline_version_title: '$t(timeline_version_title)',
      external_timeline_version_title_first_version: '$t(external_timeline_version_title)',
      external_timeline_version_title_last_version: '$t(external_timeline_version_title)',
      external_timeline_version_title_only_version: '$t(external_timeline_version_title)',
      ...
      history_version_title_last_version: '$t(history_version_title)',
      history_version_title_only_version: '$t(history_version_title)',
      external_history_version_title: '$t(history_version_title)',
      external_history_version_title_first_version: '$t(external_history_version_title)',
      external_history_version_title_last_version: '$t(external_history_version_title)',
      external_history_version_title_only_version: '$t(external_history_version_title)',
    ...
    biophysics_colab: {
      ...
      timeline_version_title_last_version: 'Curated Preprint',

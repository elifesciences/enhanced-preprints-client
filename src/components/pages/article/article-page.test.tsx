...
describe('ArticlePage', () => {
  ...
  it('passes correct doi to status component', () => {
    ...
    const { container } = render(
      <ArticleStatus doi={expectedDoi} umbrellaDoi="10.7554/eLife.85111" pdfUrl={metaData.pdfUrl} title={contentToText(metaData.title)} citation={citation} timeline={{ timelineEvents: timeline }} msid="12345"/>,
    );

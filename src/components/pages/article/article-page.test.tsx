...
import {
  metaData, peerReview, status, citation, relatedContents,
} from '../../../utils/mocks';
...
describe('ArticlePage', () => {
  it('renders correctly', () => {
    expect(() => render(<ArticlePage relatedContents={[]} msidWithVersion="12345v1" metaData={metaData} status={status} activeTab="fulltext" tabs={[]}>
  ...
  it('renders with figures tab', () => {
    expect(() => render(<ArticlePage relatedContents={[]} msidWithVersion="12345v1" metaData={metaData} status={status} activeTab="figures" tabs={[]}>
      <ArticleFiguresTab content={''} />
    </ArticlePage>)).not.toThrow();
  });

  it('renders with reviews tab', () => {
    expect(() => render(<ArticlePage relatedContents={[]} msidWithVersion="12345v1" metaData={metaData} status={status} activeTab="reviews" tabs={[]}>
  ...
  it('renders with tabs with correct active label', () => {
    ...
    render(<ArticlePage relatedContents={[]} msidWithVersion="12345v1" metaData={metaData} status={status} activeTab="fulltext" tabs={tabs}>
      <ArticleFullTextTab headings={[]} content={''} peerReview={peerReview} metaData={metaData} />
    </ArticlePage>);
    ...
    cleanup();
    render(<ArticlePage relatedContents={[]} msidWithVersion="12345v1" metaData={metaData} status={status} activeTab="figures" tabs={tabs}>
      <ArticleFullTextTab headings={[]} content={''} peerReview={peerReview} metaData={metaData} />
    </ArticlePage>);
    ...
    cleanup();
    render(<ArticlePage relatedContents={[]} msidWithVersion="12345v1" metaData={metaData} status={status} activeTab="reviews" tabs={tabs}>
      <ArticleFullTextTab headings={[]} content={''} peerReview={peerReview} metaData={metaData} />
    </ArticlePage>);
  ...
  it('renders related content', () => {
    render(<ArticlePage relatedContents={relatedContents} msidWithVersion="12345v1" metaData={metaData} status={status} activeTab="figures" tabs={[]}>
      <ArticleFullTextTab headings={[]} content={''} peerReview={peerReview} metaData={metaData} />
    </ArticlePage>);

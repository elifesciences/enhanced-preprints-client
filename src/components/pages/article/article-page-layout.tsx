  ...
  <div className={`${styles['grid-container']} ${styles['article-page']}`}>
    ...
    <div className={styles['tabbed-navigation']}>
      <ul className={styles['tabbed-navigation__tabs']}>
        <li className={`${styles['tabbed-navigation__tab-label']}${activeTab === 'fulltext' ? ` ${styles['tabbed-navigation__tab-label--active']}` : ''}`}>
          <Link href={`/reviewed-preprints/${metaData.msid}`}>Full text</Link>
        </li>
        <li className={`${styles['tabbed-navigation__tab-label']}${activeTab === 'figures' ? ` ${styles['tabbed-navigation__tab-label--active']}` : ''}`}>
          <Link href={`/reviewed-preprints/${metaData.msid}/figures`}>Figures and data</Link>
        </li>
        <li className={`${styles['tabbed-navigation__tab-label']}${activeTab === 'reviews' ? ` ${styles['tabbed-navigation__tab-label--active']}` : ''}`}>

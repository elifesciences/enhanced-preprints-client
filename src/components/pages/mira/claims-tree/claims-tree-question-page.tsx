    ...
    <main className={`page-wrapper ${dmSans.variable} ${poppins.variable}`}>
      ...
      <div className="claims-tree-pages-content">
        ...
        <div className="card">
          ...
          <div className="question-framing">

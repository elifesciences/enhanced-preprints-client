...
EventTimeline.args = {
  events: [
    { name: 'event 1', versionIdentifier: '1', date: '1999-01-01' },
    { name: 'event 2', versionIdentifier: '1', date: '2000-02-02' },
    { name: 'event 3', versionIdentifier: '1', date: '2001-03-03' },
  ],
};
...
EventTimelineISO8601.args = {
  events: [
    { name: 'event 1', versionIdentifier: '1', date: '2022-12-31T23:59:59Z' },
    { name: 'event 2', versionIdentifier: '1', date: '2023-01-01T00:00:00Z' },
  ],
};

...
export const ErrorMessages = (): JSX.Element => (
 <div className="error_container">
  ...
  <p className="error_message">The information you&apos;re looking for isn&apos;t available right now but we&apos;re working to fix it. Please try again later and thank you for your patience.</p>
</div>
);

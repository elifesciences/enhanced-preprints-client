...
export const ReviewProcess = ({
  ...
  const versionOfRecordClass = versionOfRecord ? ' review-process--version-of-record' : '';
  return (
    <section className={`review-process review-process--${type}${evaluationSummaryClass}${versionOfRecordClass}`}>

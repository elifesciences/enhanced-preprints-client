...
import { type ListContent } from './content';
...
describe('Content to JSX', () => {
  ...
  describe('list-type specified', () => {
    const listType: NonNullable<ListContent['meta']>['listType'][] = ['order', 'bullet', 'alpha-lower', 'alpha-upper', 'roman-lower', 'roman-upper', 'simple', 'custom'];

...
export const mock85111: EnhancedArticleWithVersions = {
  ...
  versions: {
    '85111v1': {
      ...
      msid: '85111',
      preprintDoi: '10.1101/2022.11.08.515698',
      preprintPosted: new Date('2022-11-22T00:00:00.000Z').toISOString() as IsoDateString,
      preprintUrl: 'https://www.biorxiv.org/content/10.1101/2022.11.08.515698v2',
    ...
    '85111v2': {
      ...
      msid: '85111',
      preprintDoi: '10.1101/2022.11.08.515698',
      preprintPosted: new Date('2023-03-20T00:00:00.000Z').toISOString() as IsoDateString,
      ...
      sentForReview: new Date('2023-03-23T10:52:45.000Z').toISOString() as IsoDateString,
...
export const vorArticleVersion = {

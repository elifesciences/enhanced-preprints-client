...
import { ArticleVersion, prepareArticleVersion } from '../../../types/article';
...
export const getServerSideProps: GetServerSideProps = async (context: GetServerSidePropsContext) => {
  ...
  const [content, peerReview, articleVersion, status] = await Promise.all([
    ...
    jsonFetch<ArticleVersion>(`${config.articleStore}/${msid}`),
  ...
  const { articleMetaData } = prepareArticleVersion(articleVersion);

...
import { type Author, fetchVersionsNoContent, type EnhancedArticle, type PeerReviewEvaluationSummaryOnly, type PublishedEnhancedArticleMetaDataForJournal } from '../../fetch-data';
import {

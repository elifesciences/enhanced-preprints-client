ARG node_version=24.13-alpine3.22
...
COPY --from=production_build /opt/epp-client/src/pages/api/static/claims-tree.css /opt/epp-client/src/pages/api/static/claims-tree.css
